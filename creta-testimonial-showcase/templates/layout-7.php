        ...
        <div class="row">
            <div class="col text-center">
                <div class="smart-slider-top-heading"
                     <?php echo ( cretats_get_inline_style(['font_family' => $font, 'font_size' => $header_font_size, 'color' => $color])); ?>>
        ...
        ?>
            <div class='testimonial-item' <?php echo  (cretats_get_inline_style(['background' => $bg_color_lighter])); ?>>
                ...
                <div class="testimonial-box" <?php echo  ( cretats_get_inline_style(['bg_color' => $bg_color])); ?>>
                    ...
                    <?php endif; ?>
                    <h5 <?php echo  (cretats_get_inline_style(['font_family' => $font, 'font_size' => $header_font_size, 'color' => $color])); ?>
                        class="smart-slider-title-layout-7">
                        <?php the_title(); ?>
                        <?php if ($designation ) : ?>
                            <span <?php echo  (cretats_get_inline_style(['font_family' => $font, 'font_size'=>$body_font_size,'color'=> $color])); ?>>
                                (<?php echo esc_html($designation); ?>)
                            </span>
                        <?php endif; ?>
                    </h5>
                    <p <?php echo  (cretats_get_inline_style(['font_family' => $font, 'font_size' => $body_font_size, 'color' => $color])); ?>
